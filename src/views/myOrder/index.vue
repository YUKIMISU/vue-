...
<div>
  <div class='header'>
    <x-header style='background:#2d8cf0;' :left-options="{showBack: false}">我的工单<a slot="right" v-on:click="showMenus = true">筛选</a></x-header>
    <search
...
this.$refs.scrollerBottom.disablePullup()
 ...
 async getData() {
   ...
   var arr =[]
  await myWorkOrder(this.params).then(res => {
    if (res.data.code === 0) {
